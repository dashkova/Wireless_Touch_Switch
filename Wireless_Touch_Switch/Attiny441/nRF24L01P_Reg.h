...
#define nRF_ENAA_P5		5							//Включить автоответ для pipe 5
...
#define nRF_ERX_P5		5							//Разрешить данные для pipe 5
#define nRF_ERX_P4		4
#define nRF_ERX_P3		3
#define nRF_ERX_P2		2
#define nRF_ERX_P1		1
...
#define nRF_RETR_250US	((0<<nRF_ARD3) | (0<<nRF_ARD2) | (0<<nRF_ARD1) | (0<<nRF_ARD0))	//Задержка перед повтором 250 мкс
#define nRF_RETR_500US	((0<<nRF_ARD3) | (0<<nRF_ARD2) | (0<<nRF_ARD1) | (1<<nRF_ARD0))	//500 мкс
#define nRF_RETR_750US	((0<<nRF_ARD3) | (0<<nRF_ARD2) | (1<<nRF_ARD1) | (0<<nRF_ARD0))	//750 мкс
#define nRF_RETR_1000US	((0<<nRF_ARD3) | (0<<nRF_ARD2) | (1<<nRF_ARD1) | (1<<nRF_ARD0))	//1 мс
#define nRF_RETR_1250US	((0<<nRF_ARD3) | (1<<nRF_ARD2) | (0<<nRF_ARD1) | (0<<nRF_ARD0))	//1,25 мс
#define nRF_RETR_1500US	((0<<nRF_ARD3) | (1<<nRF_ARD2) | (0<<nRF_ARD1) | (1<<nRF_ARD0))	//1,5 мс
#define nRF_RETR_1750US	((0<<nRF_ARD3) | (1<<nRF_ARD2) | (1<<nRF_ARD1) | (0<<nRF_ARD0))	//1,75 мс
#define nRF_RETR_2000US	((0<<nRF_ARD3) | (1<<nRF_ARD2) | (1<<nRF_ARD1) | (1<<nRF_ARD0))	//2 мс
#define nRF_RETR_2250US	((1<<nRF_ARD3) | (0<<nRF_ARD2) | (0<<nRF_ARD1) | (0<<nRF_ARD0))	//2,25 мс
#define nRF_RETR_2500US	((1<<nRF_ARD3) | (0<<nRF_ARD2) | (0<<nRF_ARD1) | (1<<nRF_ARD0))	//2,5 мс
#define nRF_RETR_2750US	((1<<nRF_ARD3) | (0<<nRF_ARD2) | (1<<nRF_ARD1) | (0<<nRF_ARD0))	//2,75 мс
#define nRF_RETR_3000US	((1<<nRF_ARD3) | (0<<nRF_ARD2) | (1<<nRF_ARD1) | (1<<nRF_ARD0))	//3 мс
#define nRF_RETR_3250US	((1<<nRF_ARD3) | (1<<nRF_ARD2) | (0<<nRF_ARD1) | (0<<nRF_ARD0))	//3,25 мс
#define nRF_RETR_3500US	((1<<nRF_ARD3) | (1<<nRF_ARD2) | (0<<nRF_ARD1) | (1<<nRF_ARD0))	//3,5 мс
#define nRF_RETR_3750US	((1<<nRF_ARD3) | (1<<nRF_ARD2) | (1<<nRF_ARD1) | (0<<nRF_ARD0))	//3,75 мс
#define nRF_RETR_4000US	((1<<nRF_ARD3) | (1<<nRF_ARD2) | (1<<nRF_ARD1) | (1<<nRF_ARD0))	//4 мс
#define nRF_AUTOREPEAT_OFF	0						//0 - отключить автоповтор
...
#define nRF_RX_P_NO2	3							// nRF_RX_P_NO2:nRF_RX_P_NO0 биты - номер канала данные по были приняты в буфер RX_FIFO
...
#define nRF_IRQ_MASK	((1<<nRF_RX_DR) | (1<<nRF_TX_DS) | (1<<nRF_MAX_RT)) //Маска флагов прерываний
...
#define nRF_DYNPD		0x1C						//DYNPD - разрешить динамическое инзменение принятых данных для пипов
#define nRF_DPL_P5		5
#define nRF_DPL_P4		4
#define nRF_DPL_P3		3
#define nRF_DPL_P2		2
...
#define nRF_FEATURE		0x1D						//FEATURE - характеристики
